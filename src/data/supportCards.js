...
const SOURCE_ROWS = [
{ supportcard_id: 'EXSP-UR003', supportcard_name: '領域',type:'賢さ',type2:''},
...
{ supportcard_id: 'SP-UR035', supportcard_name: '歪な関係',type:'キック',type2:''},
{ supportcard_id: 'SP-UR034', supportcard_name: '青い忍風録-乙夜忍法帖-',type:'スピード',type2:'テクニック'},
{ supportcard_id: 'SP-UR033', supportcard_name: '"青い監獄"ワイルドヒーロー',type:'フィジカル',type2:'キック'},
{ supportcard_id: 'SP-UR032', supportcard_name: '勝たせろクソメガネ',type:'賢さ',type2:''},
{ supportcard_id: 'SP-UR031', supportcard_name: '俺が魔法をかけてやる',type:'キック',type2:''},
{ supportcard_id: 'SP-UR030', supportcard_name: 'お返しセレクション 黒名＆潔',type:'テクニック',type2:'賢さ'},
{ supportcard_id: 'SP-UR029', supportcard_name: '閃堂の欲',type:'フィジカル',type2:''},
{ supportcard_id: 'SP-UR028', supportcard_name: 'お前は世界一になれない',type:'テクニック',type2:''},
{ supportcard_id: 'SP-UR027', supportcard_name: 'バレンタイン・シークレット',type:'賢さ',type2:'スピード'},
{ supportcard_id: 'SP-UR026', supportcard_name: '3周年記念Ver.蟻生＆千切',type:'フィジカル',type2:'テクニック'},
